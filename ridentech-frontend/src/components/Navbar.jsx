        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0" ref={logoRef} style={{ opacity: 0 }}>
            <Link href="/" className="flex items-center group">
              <div className="w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mr-3 transform group-hover:rotate-6 transition-transform duration-300">
                <Layers className="w-5 h-5 text-white" />
              </div>
              <span className="font-marcellus text-2xl tracking-wide text-gray-900">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-1">
            {navItems.map((item, index) => (
              ...
              >
                {item.dropdown ? (
                  <button
                    className={`flex items-center space-x-1 px-4 py-2 text-sm font-medium relative group font-manrope ${activeDropdown === item.title
                        ? "text-gray-900"
